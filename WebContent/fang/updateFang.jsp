...
<html>
	...
	<body >
	<h3 style="text-align:center">房产修改页面</h3>
<form class="form-horizontal" action="/Extreme/fangAction?mark=update" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input name="buildingId" type="text" class="form-control"  value="${h.buildingId}" placeholder="楼栋号">
        </div>
    </div>
    <div class="form-group">
        <label  class="col-sm-4 control-label">单元号</label>
        <div class="col-sm-6">
            <input name="unitId" type="text" class="form-control"  value="${h.unitId }" placeholder="单元号">
        </div>
    </div>
    <div class="form-group">
        <label  class="col-sm-4 control-label">房间号</label>
        <div class="col-sm-6">
            <input name="fangId" type="text" class="form-control"  value="${h.fangId }" placeholder="房间号">
        </div>
    </div>
    <div class="form-group">
        <label  class="col-sm-4 control-label">户型图编号</label>
        <div class="col-sm-6">
            <input name="floorPlanId" type="text" class="form-control" value="${h.floorPlanId }" placeholder="户型图编号">
        </div>
    </div> <div class="form-group">
    <label  class="col-sm-4 control-label">卧室</label>
    <div class="col-sm-6">
        <input name="roomCount" type="text" class="form-control"  value="${h.roomCount}" placeholder="卧室">
    </div>
</div>
    <div class="form-group">
        <label  class="col-sm-4 control-label">客厅</label>
        <div class="col-sm-6">
            <input name="livingRoomCount" type="text" class="form-control"  value="${h.livingRoomCount }" placeholder="客厅">
        </div>
    </div>
    <div class="form-group">
        <label  class="col-sm-4 control-label">厨房</label>
        <div class="col-sm-6">
            <input name="kitchenCount" type="text" class="form-control"   value="${h.kitchenCount}" placeholder="厨房">
        </div>
    </div>
    <div class="form-group">
        <label  class="col-sm-4 control-label">卫生间</label>
        <div class="col-sm-6">
            <input name="toiletCount" type="text" class="form-control"  value="${h.toiletCount }" placeholder="卫生间">
        </div>
    </div>
    <div class="form-group">
