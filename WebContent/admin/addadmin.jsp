...
<html>
	...
	<font id='fonttop' color="red"></font>
		<form action="adminServlet?mark=addadmin" method="post" onsubmit="verify4()" >
		<table width="100%" border='1px'>
		<tr>
		<td align="right">账号:</td>
		<td ><input type='text' name = 'uname' onblur="verify(this.value)" /><font color="red" id='font1'></font><font color="green" id='font11'></font></td>
		</tr>
		<tr>
		...
		<td ><input type='text' name = 'phone' onblur="verify2(this.value)" /><font color="red" id='font4'></font><font color="green" id='font44'></font></td>
		</tr>
		<tr>
		<td align="right">电子邮箱:</td>
		<td ><input type='text' name = 'emal' onblur="verify3(this.value)" /><font color="red" id='font5'></font><font color="green" id='font55'></font></td>
		</tr>
		<tr>
...
function verify4(){
	...
	var arr = [font1,font2,font3,font4,font5];
